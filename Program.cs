...
*/
//attacks setup;  Deprecated, new item handling in progress. left working to not cause issues with current attack menu
...
void attackMeny(){                                                                       //Gör menyn som visar vad man kan attakera med
    ...
    Console.WriteLine("|                         |");
    /*//NEEDS REWORK FOR NEW ITEM HANDLING SYSTEM
    for (int menyLine = 0; menyLine != equipedAttacks.Length; menyLine++){
        ...
        string lineFiller = "                      ";
        lineFiller = lineFiller.Substring(0, 22 - tempEquip[0].Length);                //checks lenght of equipment name
...
void figthingStylesMeny(){                    //Gör menyn som visar vad man den innehåller --kan attakera med--
...
void actionStyleChange(){      //gör skälva bytet av fightingStyle
